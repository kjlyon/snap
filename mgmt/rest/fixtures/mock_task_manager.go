...
func (t *mockTask) WMap() *wmap.WorkflowMap                   { return wmap.NewWorkflowMap() }
...
func (m *MockTaskManager) CreateTask(sch schedule.Schedule, wmap *wmap.WorkflowMap, start bool, opts ...core.TaskOption) (core.Task, core.TaskErrors) {
	return &mockTask{
		MyID:                "MyTaskID",
		MyName:              "NewTaskCreated",
